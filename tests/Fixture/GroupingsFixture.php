...
class GroupingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'grouping_number' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'business_id' => 1,
                'grouping_number' => 'Lorem ipsum dolor sit amet',
                'company_id' => 1,
                'created' => '2022-01-19 17:44:42',
                'modified' => '2022-01-19 17:44:42',
            ],
        ];
        parent::init();
    }
