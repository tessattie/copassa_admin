 ...
 *
 * @method \App\Model\Entity\FoldersFile newEmptyEntity()
 * @method \App\Model\Entity\FoldersFile newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\FoldersFile[] patchEntities(iterable $entities, array $data, array $options = [])
 ...
 * @method \App\Model\Entity\FoldersFile[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\FoldersFile[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\FoldersFile[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\FoldersFile[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 *
